...
impl From<&GenericRange<u64>> for Fragment {
	fn from(range: &GenericRange<u64>) -> Fragment {
		match (range.start_bound(), range.end_bound()) {
			...
			(Bound::Included(s), Bound::Included(e)) => Fragment {
				offset: *s,
				size: (*e - *s + 1) as usize,
			},
			(Bound::Included(s), Bound::Excluded(e)) => Fragment {
				offset: *s,
				size: (*e - *s) as usize,
			},
			(Bound::Excluded(s), Bound::Excluded(e)) => Fragment {
				offset: *s + 1,
				size: (*e - *s - 1) as usize,
			},
			(Bound::Excluded(s), Bound::Included(e)) => Fragment {
				offset: *s + 1,
				size: (*e - *s) as usize,
			},
